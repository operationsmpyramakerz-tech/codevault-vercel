...
// Map internal codes to Notion Select labels
const TYPE_NAME_MAP = {
...
app.post(
  ...
  (req, res) => {
    ...
    req.session.orderDraft = req.session.orderDraft || {};
    req.session.orderDraft.type = code;      // keep the code as-is for compatibility
    req.session.orderDraft.typeLabel = lbl;  # store a human-readable label for later
...
app.post(
  ...
  async (req, res) => {
    ...
    // Resolve human-readable label for Notion Select
    let typeLabel = "";
